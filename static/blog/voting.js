...
for(var i=0;i<img2per.length;i++)
{
  ...
  console.log(img2per[i].parentNode.parentNode.children[1].children[2])
  let y = (100-dlike1);  
...
//document.querySelector("#img1").style.transform='rotate(360deg)';
        ...
        var per1 = cur.parentNode.parentNode.parentNode.children[1].children[2].innerText;
        var per2 =cur.parentNode.parentNode.parentNode.children[2].children[2].innerText;
        var pers2 = 100 - parseInt(per1);
